...
const changeAppointmentStatus = async (appointmentId: string, status: AppointmentStatus, user: IJWTPayload) => {
...
const cancelUnpaidAppointments = async () => {
    ...
    await prisma.$transaction(async (tx) => {
        // First delete prescriptions related to these appointments
